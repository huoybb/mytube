        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            {% if auth.isLogin() %}
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">我的影单<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="{{ url(['for':'watchlists.want']) }}">想看的视频</a></li>
                            <li><a href="{{ url(['for':'watchlists.doing']) }}">在看的视频</a></li>
                            <li><a href="{{ url(['for':'watchlists.done']) }}">看过的视频</a></li>
                        </ul>
                    </li>
                    <li><a href="{{ url(['for':'attachments.index']) }}">我的附件</a></li>
                </ul>
            {% endif %}
