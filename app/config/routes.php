...
$router->group([isLogin::class],function() use($router){
    ...
    $router->addPost('/movies/{movie:[0-9]+}/addTag','movies::addTag','movies.addTag')->setMiddlewares([checkToken::class,TagsForm::class]);
    ...
    $router->addPost('/playlists/{playlist:[0-9]+}/addComment','playlists::addComment')->setName('playlists.addComment')->setMiddlewares([checkToken::class,CommentsForm::class]);
    ...
    $router->addPost('/playlists/{playlist:[0-9]+}/addTag','playlists::addTag')->setName('playlists.addTag')->setMiddlewares([checkToken::class,TagsForm::class]);
    ...
    $router->addPost('/tags/{tag:[0-9]+}/addComment','tags::addComment')->setName('tags.addComment')->setMiddlewares([checkToken::class,CommentsForm::class]);
    $router->addx('/tags/{tag:[0-9]+}/edit','tags::edit')->setName('tags.edit')->setMiddlewares([checkToken::class,TagsForm::class]);
